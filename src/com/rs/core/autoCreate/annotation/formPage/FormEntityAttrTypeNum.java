...
@Documented
public @interface FormEntityAttrTypeNum {
	// ------------------------------------基础属性--------------------------------------
	...
	// 第一个是if条件,第二个是showTitle,第三个是属性名,第四个是扩展属性如禁止编辑只读等,第五个是parseInt或者parseFloat
	String temp() default "      <el-form-item %s label=\"%s\">\r\n    <el-input type=\"number\" v-model=\"form.%s\"  %s onblur=\"this.value=%s(this.value)\" />\r\n</el-form-item>";
